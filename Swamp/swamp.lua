...
minetest.register_decoration({
	...
	minetest.register_decoration({
		...
		y_max = 10,
		y_min = 1,
		schematic = minetest.get_modpath("swamp") .. "/schematics/mang_1_Dying.mts",
		flags = "place_center_x, place_center_z",
		rotation = "random"
	})
	...
	minetest.register_decoration({
		...
		y_max = -1,
		y_min = -1,
		schematic = minetest.get_modpath("swamp") .. "/schematics/mang_1_1_Dying.mts",
		flags = "place_center_x, place_center_z, force_placement",
		rotation = "random"
	})
